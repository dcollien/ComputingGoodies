...
var flickerBar = "https://openlearning.cse.unsw.edu.au/site_media/viewer/media/bar.png";
var overlay = false;
...
function tileURL( x, y, zoom ) {
    ...
    var tilename = 'X' + center.x + "_Y" + center.y + "_Z" + zoom + "." + fileType + getString; //+ "?width=512&height=512&colourmap=6";
